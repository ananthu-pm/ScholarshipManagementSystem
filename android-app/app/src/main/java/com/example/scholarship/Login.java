...
public class Login extends AppCompatActivity implements com.example.scholarship.JsonResponse {
...
//        t1=(TextView)findViewById(R.id.signup);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (com.example.scholarship.JsonResponse) Login.this;
        ...
        try {
            ...
            if (status.equalsIgnoreCase("success")) {
                ...
                if(user_type.equals("student"))
                {
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.scholarship.userhome.class));
                }
